...
app.get("/api/search", async (req, res) => {
  try {
    ...
    const debugConsumption =
      typeof req.query.debug_verbrauch !== "undefined" &&
      ["1", "true", "ja", "yes", "on"]
        .includes(String(req.query.debug_verbrauch).trim().toLowerCase());
    ...
    const searchProjection = {
      ...
      _ps_raw: 0, _seats_raw: 0, _ccm_raw: 0, _halter_raw: 0,
      _ps_match: 0, _seats_match: 0, _ccm_match: 0,
    ...
    if (!debugConsumption) {
      Object.assign(searchProjection, {
        _verb_raw: 0, _verb_raw_other: 0,
        _verb_norm: 0, _verb_liters: 0, _verb_kwh: 0, _verb_all_any: 0,
